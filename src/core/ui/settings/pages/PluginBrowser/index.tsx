...
import { DissonancePluginManifestInternal } from "@lib/addons/plugins/types";
...
function PluginCard(props: { manifest: DissonancePluginManifestInternal; }) {
            ...
            <AlertActionButton
                ...
                onPress={async () => {
                    try {
                        ...
                        dismissAlert("dissonance-add-plugin-repository");
                        showSheet("plugin-browser-options", PluginBrowserOptions);
                    }
                }} />
        </AlertActions>} />;
    ...
    return <ActionSheet>
        <TableRowGroup title="Repositories">
            ...
            <TableRow
                ...
                onPress={() => {
                    openAlert("dissonance-add-plugin-repository", <AddRepositoryAlert />);
...
function RepositoryRow(props: { url: string; }) {
    ...
    return (
        <TableRow
            label={isOfficial ? "Dissonance's Repository" : (repo.$meta?.name ?? "Unknown")}
            subLabel={props.url}
            trailing={(
                <Stack direction="horizontal">
                    ...
                    <IconButton
                        ...
                        onPress={() => {
                            openAlert("dissonance-remove-repository", <AlertModal
                                ...
                                actions={<AlertActions>
                                    <AlertActionButton
                                        ...
                                        onPress={async () => {
                                            ...
                                            dismissAlert("dissonance-remove-repository");
                                        }}
                                    />
                                </AlertActions>}
                            />);
