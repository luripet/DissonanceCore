...
const config = {
    ...
    legalComments: "none",
    alias: {
        "!dissonance-deps-shim!": "./shims/depsModule.ts",
    ...
    plugins: [
        globalPlugin({
            ...metroDeps.reduce((obj, key) => {
                obj[key] = `require("!dissonance-deps-shim!")[${JSON.stringify(key)}]`;
                return obj;
            }, {})
        }),
        {
